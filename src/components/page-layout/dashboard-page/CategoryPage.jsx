...
const CategoryPage = () => {
  ...
  return (
    <section className="text-center font-sans">
      <p className=" font-bold text-4xl"> Section is Closed Permanently</p>
      <p className="mt-1 font-normal text-lg">
        Category Has Been Shifted to Static for Optimization
      </p>
    </section>
